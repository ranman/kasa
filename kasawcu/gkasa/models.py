...
class Student(models.Model):
    student_id = models.IntegerField(primary_key=True, unique=True, db_index=True, max_length=9)
...
class Course(models.Model):
    course_id = models.AutoField(primary_key=True, unique=True, db_index=True, max_length=4)
...
class Lab(models.Model):
    lab_id = models.AutoField(primary_key=True, unique=True, db_index=True, max_length=4)
    title = models.CharField(max_length=50)
...
class Requirement(models.Model):
    req_id = models.AutoField(primary_key=True, unique=True, db_index=True, max_length=3)
